    ...
    <div class="forgotContainer">
      ...
      <div class="contentForm">
        <div class="form">
          ...
          <form class="formCheckOtp" onsubmit="return validateForm()" action="createNewPassword" method="post">
            <div class="form-group">
              <%--@declare id="newpassword"--%><label for="newpassword">New password</label>
              <input
                type="password"
                class="form-control"
                id="password"
            ...
            <button
              type="submit"
              class="btn btn-primary checkOtpBtn"
              style="width: 100%"
            >
              Create
            </button>
